...
const conceptNameSet = new Set(conceptNameList);
const conceptRegex = new RegExp(
  `\\b(${[...conceptNameSet].join("|")})\\b`,
  "gi"
);
...
export default function () {
  ...
  for (let i = 0; i < linesLen; i++) {
    ...
    let matches;
    while ((matches = conceptRegex.exec(line)) !== null) {
      allMatches.push([i, matches[0], matches.index, conceptRegex.lastIndex]);
    }
  }
